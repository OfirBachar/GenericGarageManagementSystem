...
namespace Ex03.GarageLogic
{
    ...
    {
        public const FuelEngine.eFuelTypes k_FuelType = FuelEngine.eFuelTypes.Octan98;
        public const float k_MaxFuelLiters = 6.2f;
        ...
        public FuelMotorcycle(FuelEngine.eFuelTypes i_FuelType, float i_MaxFuelLiters, float i_MaxAirPressure, int i_NumOfWheels) : base(i_MaxAirPressure, i_NumOfWheels)
        {
