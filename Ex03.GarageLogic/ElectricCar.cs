...
namespace Ex03.GarageLogic
{
    ...
    {
        public const float k_MaxBatteryHours = 3.3f;
        ...
        public ElectricCar(float i_MaxBatteryHours, float i_MaxAirPressure, int i_NumOfWheels) : base(i_MaxAirPressure, i_NumOfWheels)
        {
